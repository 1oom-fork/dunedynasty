...
/*	DRAW_MODE_XORFILLED_RECTANGLE = 6, */
...
extern uint16  GUI_Widget_HandleEventsKey(Widget *w, uint16 key);
...
extern bool GUI_Widget_Portrait_Click(Widget *w);
extern bool GUI_Widget_Cancel_Click(Widget *w);
extern bool GUI_Widget_Status_Click(Widget *w);
